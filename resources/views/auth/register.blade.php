      ...
      <div class="card-body">
        ...
        <form method="POST" action="{{ route('register') }}">
          ...
          <div class="input-group mb-3">
            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required placeholder="Nama Lengkap" autofocus>
            @error('name')
        ...
        <p class="mb-0">
          <a href="{{url('login')}}" class="text-center">Have An Account? Login here</a>
        </p>
      </div>
      <!-- /.card-body -->
    </div>
