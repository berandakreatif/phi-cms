<div>
        ...
        <section class="contactPage">
            <div class="SecLayerimg move_anim">
                <img src="{{asset('frontend')}}/dgita/images/bg/s34.png" alt="" />
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="contactInfo">
                                        <img src="{{asset('frontend')}}/dgita/images/c1.png" alt="" />
                                        <h4>Phone</h4>
                                        <p>
                                    ...
                                    <div class="contactInfo">
                                        <img src="{{asset('frontend')}}/dgita/images/c2.png" alt="" />
                                        <h4>Address</h4>
                                        <p>
                                            Boat House, 2/21 City Road Hoxton, N1 6NG, UK
                                        </p>
                                    </div>
                                </div>
                            </div>
